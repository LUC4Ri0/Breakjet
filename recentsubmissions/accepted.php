...
<ul class="nav nav-tabs">
    ...
    <li class="nav-item">
        <a class="nav-link active" href="#">Codes Broken</a>
    </li>
</ul>
<br>
    <center>
    ...
    <tbody>
        <?php
            ...
            foreach($arr as $obj){ ?>
            <tr class="bg-success">
                <th class="bg-success" scope="row"><?php echo $obj->id;?></th>
                <td class="bg-success"><a style="color : white;" href="../prob/?id=<?php echo $obj->id;?>"><?php echo $obj->title;?></a></td>
                <td class="bg-success"><?php echo $obj->date;?></td>
            </tr>
            <?php 
            }
        }
